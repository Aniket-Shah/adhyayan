...
<div class="container" style="max-width: 50%;	font-family: 'Montserrat', sans-serif;">
  <h2 align="center" style="color: white; margin-top:20px;" data-aos="fade-up" data-aos-ease="ease-in-out" class="aos-init aos-animate">Create Account</h2>
  <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
    ...
    <button type="submit" name="submit" class="btn btn-full"data-aos="fade-up" data-aos-ease="ease-in-out" class="aos-init aos-animate" style="	border: 1px solid black;color:white;">Create Account</button>
  </form>
</div>
